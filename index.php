<?php 
	...
	if($messageInput=="Work At Home µÍ¹äË¹"){
		$messages['messages'][0] = getFormatTextMessage("ÁÕáµè Work At Bui!!! By CEO");
	}else if($messageInput=="¤ÃÒ§ª×èÍ¾ÕèÇÔ·ÙÅË¹èÍÂ¤ÃÑº"){
		$messages['messages'][0] = getFormatTextMessage("âÍêÂæææ ÍêÒæææ ·ÙÅÅÅ¤ÃéÒÒÒÒ");

	
	}else{
		$messages['messages'][0] = getFormatTextMessage("¶ÒÁäÃµÍºä´é");
	}
